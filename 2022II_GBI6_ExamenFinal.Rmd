...
En la figura anterior da a conocer las 3 especies de pingunos que se van diferenciando según el pico, ya sea el ancho o el largo del pico, tambien se diferencia por la coloracion del pico de cada especie.
Así mismo, se observa las edades de tipo de especies del pinguino, ya que se diferencia tambien por el sexo y el lugar al que pertenece cada pinguino
...
**INTERPRETACIÓN**
En la siguiente tabla da a conocer los largos de los picos del piguino palmer, en el cual se diferencia el largo del pico que va depender a tamañano de pinguino
...
# Codigo para ver el mapa de calor
